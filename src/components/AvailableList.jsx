...
import { fetchAvailable } from "../features/availableSlice";
...
const AvailableSwiper = () => {
  const dispatch = useDispatch();
  const { items, status, error } = useSelector((state) => state.available);
...
export default AvailableSwiper;
